...
$arsip_id = isset($_GET['id']) ? $_GET['id'] : 0;
$user_id = $_SESSION['id'];

// Simpan data ke tabel riwayat_preview
$query = "INSERT INTO riwayat_preview (riwayat_preview_waktu, riwayat_user, riwayat_arsip) VALUES (NOW(), '$user_id', '$arsip_id')";
