            ...
            <div class="pull-right">
                <form id="printForm" method="POST" action="../cetak_arsip_kegiatan.php" target="_blank">
                    ...
                    <a href="../cetak_arsip_kegiatan.php<?php if (isset($_GET['filter_tanggal_awal'])) {
                     ...
                     } ?>" class="btn btn-primary" target="_blank" class="btn btn-primary" type="button"
                        onclick="submitPrintForm()"><i class="fa fa-print"></i> Cetak Arsip Sub
                        Kegiatan</a>
                </form>
            </div>
            <!-- <form id="printForm" method="POST" action="../cetak_arsip_kegiatan.php" target="_blank">
                <input type="hidden" name="selected_ids" id="selected_ids">
                <button class="btn btn-primary" type="button" onclick="submitPrintForm()">Cetak Arsip Terpilih</button>
            </form> -->
        </div>
                ...
                <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                <td><input type="checkbox" name="id[]" value="<?php echo $row['id_arsip_kegiatan']; ?>">
                                </td>
                                <td><?php echo $no++; ?></td>
