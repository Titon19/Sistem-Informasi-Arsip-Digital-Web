    ...
    <div class="panel panel">
        ...
        <div class="panel-heading">
            <div class="pull-right">
                <form id="printForm" method="POST" action="../cetak_riwayat_unduhan.php" target="_blank">
                    ...
                    <a href="../cetak_riwayat_unduhan.php<?php if (isset($_GET['filter_tanggal_awal'])) {
        ...
        <div class="panel-body">
            <form id="deleteForm" method="POST" action="deleteOptionRiwayat.php">
                    ...
                    <tbody>
                        ...
                        if ($result) {
                            while ($p = mysqli_fetch_array($result)) {
                                ?>
                                <tr>
                                    <td><input type="checkbox" name="id[]" value="<?php echo $p['riwayat_id']; ?>">
                                    </td>
                                    <td><?php echo $no++; ?></td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="riwayat_hapus.php?id=<?php echo $p['riwayat_id']; ?>"
