                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="user.php" aria-expanded="false"><span
                                    class="educate-icon educate-professor icon-wrap sub-icon-mg"
                                    aria-hidden="true"></span> <span class="mini-click-non">Data Anggota</span></a>
                        </li>
                        ...
                        <!-- <li>
                            <a href="kegiatan.php" aria-expanded="false"><span
                                    class="educate-icon educate-data-table icon-wrap sub-icon-mg"
                                    aria-hidden="true"></span> <span class="mini-click-non">Data Kegiatan</span></a>
                        </li> -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <span class="educate-icon educate-data-table icon-wrap sub-icon-mg"
                                    aria-hidden="true"></span> <span class="mini-click-non">Master Arsip Kegiatan</span>
                            </a>
                            <ul class="dropdown-menu ">
                                <li><a class="dropdown-item " href="kegiatan.php">Kegiatan</a></li>
                                <li><a class="dropdown-item" href="penyedia.php">Penyedia</a></li>
                                <li><a class="dropdown-item" href="arsip_kegiatan.php">Arsip Kegiatan</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <span class="educate-icon educate-data-table icon-wrap sub-icon-mg"
                                    aria-hidden="true"></span> <span class="mini-click-non">Riwayat</span>
                            </a>
                            <ul class="dropdown-menu ">
                                <li><a class="dropdown-item " href="riwayat.php">Riwayat Unduhan</a></li>
                                <li><a class="dropdown-item" href="riwayat_preview.php">Riwayat Preview</a></li>
                            </ul>
                        </li>
